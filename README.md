...
*Pour ma communauté* *:* Vérfier le code; adapter à votre situation. 
> Attention : Exécutez pas le programme, afin de ne pas impacter votre système de fichiers. 

#Pour les curieux, envie de tester ? Alors comprenez, et exécutez en ayant tout entiere votre responsabilite > dossier "test"

/débutant-Intermédiaire en dev python (en cours d'apprentisage)
